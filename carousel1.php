...
<body>
    ...
    <?php
    $slider = $db->query("SELECT * from article order by articleId DESC LIMIT 5")->fetchAll(PDO::FETCH_ASSOC);
    ?>
    ...
    <div id="myslidshow" class="carousel slide carousel-fade" data-ride="carousel">
        <ol class="carousel-indicators">
            ...
            ?>
                <li class="<?= $actives;  ?>" data-target="#myslidshow" data-slide-to=" <?= $i; ?>"></li>
            <?php $i++;
            } ?>
        </ol>
        <div class="carousel-inner">
            ...
            <div class="carousel-item <?= $actives; ?>">
                <img src="./assets/img/articleImages/<?php echo $row['articleImage'];?>" class="d-block w-100" height="400">

                <!-- <div class="carousel-caption d-none d-md-block" style="color: red; align-items:center; text-align:center">
                    <h4>'.$slide['articleTitle'].'</h4>
                    <p style="text-align: center;">'.$slide['articleDescrip'].'</p>
                </div> -->
                <?php $i++; }?>
            </div>
